...
export default function Contact() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_fgqcf6g', 'template_r2ej0ii', e.target, 'user_YGWBKQ0TxdOqra3kZl7jl')
      .then((result) => {
  ...
  return (
    ...
    <div className="form">
            <form  onSubmit={sendEmail}>
                ...
                <img className='button-icon' src='./assets/mail-send-email.svg' alt='icon'/>
